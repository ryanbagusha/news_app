...
class NasionalSection extends StatefulWidget {
  @override
  State<NasionalSection> createState() => _NasionalSectionState();
}

class _NasionalSectionState extends State<NasionalSection> {
  ...
  void initState() {
    super.initState();
    listBerita = service.getBeritaKategori(2);
    // print(listData);
  }
