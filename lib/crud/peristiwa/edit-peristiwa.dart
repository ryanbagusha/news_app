...
class EditPeristiwaPage extends StatefulWidget {
  final BeritaModel berita;

  const EditPeristiwaPage({Key? key, required this.berita}) : super(key: key);
  @override
  State<EditPeristiwaPage> createState() => _EditPeristiwaPageState();
}

class _EditPeristiwaPageState extends State<EditPeristiwaPage> {
