...
import 'package:news/crud/kategori/add-kategori.dart';
import 'package:news/crud/kategori/edit-kategori.dart';
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () {
          Navigator.of(context).pushReplacement(new MaterialPageRoute(
              builder: (BuildContext context) => new AddKategoriPage()));
        },
        backgroundColor: Color(0xff00579c),
