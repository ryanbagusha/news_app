...
class EditKategoriPage extends StatefulWidget {
  ...
  const EditKategoriPage({Key? key, required this.kategori}) : super(key: key);

  @override
  State<EditKategoriPage> createState() => EditKategoriPageState();
}

class EditKategoriPageState extends State<EditKategoriPage> {
  TextEditingController txtNama = TextEditingController();
  TextEditingController txtDeskripsi = TextEditingController();

  void editData() async {
    var params = "kategori/edit_kategori.php";
  ...
  @override
  void initState() {
    txtNama = new TextEditingController(text: widget.kategori.nama);
    txtDeskripsi = new TextEditingController(text: widget.kategori.deskripsi);
